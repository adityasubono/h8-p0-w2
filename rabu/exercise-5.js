...
function formASentence() {
    ...
    console.log('\n');
    console.log('Soal 1 Lets Form a Sentence');
    console.log(word);
}
formASentence();
...
console.log('\n');
console.log('Soal 2 Index Accessing - 1 by 1');
...
var thirdWord3 = word.substring(17, 19);
var fourthWord3 = word.substring(21, 23);
var fifthWord3 = word.substring(25, 29);

console.log('\n');
console.log('Output Sola 3 Breaking Sentence (Again) using Substring');
console.log('First Word: ' + exampleFirstWord);
console.log('Second Word: ' + secondWord);
console.log('Third Word: ' + thirdWord);
console.log('Fourth Word: ' + fourthWord);
...
console.log('\n');
console.log('Output Soal 4 Breaking Sentence (yet Again) and Count Each Length');
